...
let $doc := doc('/db/madrid/xml/tds-placeography.xml')
...
let $placesexclusionnodes :=  <place xml:id="{$placesexclusion}" xmlns="http://www.tei-c.org/ns/1.0"><note>NEW-PLACE</note><bibl>OBRATDS</bibl></place>
